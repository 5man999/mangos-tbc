...
#define S_FORTITUDE             21564
#define S_WISDOM                25918
#define S_MIGHT               	25916
#define S_SALVATION             25895
#define S_KINGS                 25898
...
void SendActionMenu_npc_buffs(Player* pPlayer, Creature* pCreature, uint32 uiAction)
{
	...
	case GOSSIP_ACTION_INFO_DEF + 3:
		pPlayer->CastSpell(pPlayer, S_MIGHT, TRIGGERED_OLD_TRIGGERED);
		pPlayer->CLOSE_GOSSIP_MENU();
		break;
